...
export class DashboardService {
  ...
  getAllEmployeeSalaryDetails(): Observable<any> {
    return this.http.get(`${this.baseUrl}?route=getAllEmployeeSalaryDetails`);
  }
   // New method for worked hours details
   getAllEmployeeWorkedHours(): Observable<any> {
    return this.http.get(`${this.baseUrl}?route=getAllEmployeeSalaryDetails`);
  }
}
